...
public class GameboardUnitTest {
    ...
    public static class Move {
        ...
        public static class OccupiedToOtherOccupied {
            ...
            @Parameter
            public ChessColor originPieceColor;
            @Parameter(value = 1)
            ...
            @Parameter(value = 7)
            public ChessColor destinationPieceColor;
            @Parameter(value = 8)
            ...
            @Parameters(name = "{index}: setAsMoved {0} {2} from {6} to {13} when destination is occupied by a {7} {9}. ")
            public static Object[][] data() {
                return new Object[][]{

                        // generated using pict for pairwise combinations
                        // see docs/6_test_data/test_design/all_pairs/pict/for_unit_tests/match/Gameboard/setAsMoved/OccupiedToOtherOccupied* files
                        //
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'g', 6, 6, 2, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'e', 4, 6, 2,},
                        {ChessColor.BLACK, King.class, King.class.getSimpleName(), 'g', 6, 5, 3, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'b', 1, 2, 6,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'd', 3, 6, 2, ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'h', 7, 4, 4,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'h', 7, 6, 2, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'd', 3, 1, 7,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'c', 2, 4, 4, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'c', 2, 7, 1,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'a', 0, 3, 5, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'g', 6, 6, 2,},
                        {ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'f', 5, 1, 7, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'c', 2, 8, 0,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'a', 0, 6, 2, ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'f', 5, 3, 5,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'c', 2, 8, 0, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'a', 0, 5, 3,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'b', 1, 2, 6, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'f', 5, 1, 7,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'f', 5, 7, 1, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'e', 4, 3, 5,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'a', 0, 7, 1, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'b', 1, 1, 7,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'e', 4, 5, 3, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'd', 3, 4, 4,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'e', 4, 8, 0, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'g', 6, 7, 1,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'e', 4, 2, 6, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'b', 1, 8, 0,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'h', 7, 1, 7, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'a', 0, 2, 6,},
                        {ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'c', 2, 2, 6, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'h', 7, 2, 6,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'd', 3, 4, 4, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'f', 5, 5, 3,},
                        {ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'c', 2, 7, 1, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'd', 3, 6, 2,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'b', 1, 5, 3, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'g', 6, 3, 5,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'h', 7, 3, 5, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'e', 4, 7, 1,},
                        {ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'g', 6, 1, 7, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'g', 6, 5, 3,},
                        {ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'f', 5, 4, 4, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'g', 6, 2, 6,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'd', 3, 1, 7, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'h', 7, 6, 2,},
                        {ChessColor.BLACK, King.class, King.class.getSimpleName(), 'a', 0, 4, 4, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'a', 0, 8, 0,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'h', 7, 8, 0, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'h', 7, 3, 5,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'd', 3, 7, 1, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'g', 6, 8, 0,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'd', 3, 5, 3, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 7, 1,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'd', 3, 8, 0, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'e', 4, 1, 7,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'g', 6, 8, 0, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'c', 2, 4, 4,},
                        {ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'e', 4, 3, 5, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 6, 2,},
                        {ChessColor.BLACK, King.class, King.class.getSimpleName(), 'e', 4, 7, 1, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'c', 2, 5, 3,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 2, 6, ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'd', 3, 5, 3,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'f', 5, 5, 3, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'h', 7, 1, 7,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'c', 2, 3, 5, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'f', 5, 8, 0,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'g', 6, 4, 4, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'b', 1, 1, 7,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'a', 0, 8, 0, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'c', 2, 2, 6,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'c', 2, 1, 7, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'b', 1, 4, 4,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'b', 1, 6, 2, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'b', 1, 7, 1,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'e', 4, 6, 2, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'e', 4, 2, 6,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'h', 7, 2, 6, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'c', 2, 6, 2,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'b', 1, 7, 1, ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'a', 0, 4, 4,},
                        {ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'f', 5, 3, 5, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'b', 1, 5, 3,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'g', 6, 2, 6, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'a', 0, 3, 5,},
                        {ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'h', 7, 5, 3, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'f', 5, 4, 4,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'g', 6, 6, 2, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'd', 3, 8, 0,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'g', 6, 7, 1, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'f', 5, 7, 1,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'b', 1, 3, 5, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'd', 3, 3, 5,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'a', 0, 2, 6, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'e', 4, 4, 4,},
                        {ChessColor.BLACK, King.class, King.class.getSimpleName(), 'f', 5, 2, 6, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'g', 6, 7, 1,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'd', 3, 2, 6, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'b', 1, 3, 5,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'b', 1, 5, 3, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'e', 4, 5, 3,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'b', 1, 4, 4, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'd', 3, 2, 6,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'e', 4, 3, 5, ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'h', 7, 4, 4,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'f', 5, 8, 0, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'f', 5, 6, 2,},
                        {ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'h', 7, 4, 4, ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'e', 4, 8, 0,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'e', 4, 1, 7, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'f', 5, 2, 6,},
                        {ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'd', 3, 4, 4, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'c', 2, 3, 5,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'b', 1, 1, 7, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'd', 3, 3, 5,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 4, 4, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'h', 7, 4, 4,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'b', 1, 5, 3, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'c', 2, 6, 2,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'e', 4, 4, 4, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'a', 0, 1, 7,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'f', 5, 6, 2, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'a', 0, 5, 3,},
                        {ChessColor.BLACK, King.class, King.class.getSimpleName(), 'g', 6, 3, 5, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'c', 2, 1, 7,},
                        {ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'h', 7, 8, 0, ChessColor.WHITE, King.class, King.class.getSimpleName(), 'b', 1, 6, 2,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'h', 7, 7, 1, ChessColor.WHITE, Rook.class, Rook.class.getSimpleName(), 'h', 7, 5, 3,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'f', 5, 1, 7, ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'd', 3, 4, 4,},
                        {ChessColor.WHITE, King.class, King.class.getSimpleName(), 'c', 2, 4, 4, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'g', 6, 6, 2,},
                        {ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 5, 3, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'd', 3, 7, 1,},
                        {ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'a', 0, 1, 7, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'h', 7, 7, 1,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'e', 4, 8, 0, ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'd', 3, 3, 5,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'c', 2, 1, 7, ChessColor.WHITE, Bishop.class, Bishop.class.getSimpleName(), 'e', 4, 1, 7,},
                        {ChessColor.BLACK, Pawn.class, Pawn.class.getSimpleName(), 'c', 2, 6, 2, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'g', 6, 3, 5,},
                        {ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'b', 1, 8, 0, ChessColor.BLACK, Knight.class, Knight.class.getSimpleName(), 'h', 7, 8, 0,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'd', 3, 3, 5, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'd', 3, 2, 6,},
                        {ChessColor.WHITE, Knight.class, Knight.class.getSimpleName(), 'g', 6, 5, 3, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'h', 7, 8, 0,},
                        {ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'h', 7, 5, 3, ChessColor.BLACK, Bishop.class, Bishop.class.getSimpleName(), 'g', 6, 4, 4,},
                        {ChessColor.BLACK, Queen.class, Queen.class.getSimpleName(), 'c', 2, 5, 3, ChessColor.BLACK, King.class, King.class.getSimpleName(), 'g', 6, 1, 7,},
                        {ChessColor.BLACK, Rook.class, Rook.class.getSimpleName(), 'a', 0, 6, 2, ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'c', 2, 4, 4,},
                        {ChessColor.WHITE, Queen.class, Queen.class.getSimpleName(), 'g', 6, 7, 1, ChessColor.WHITE, Pawn.class, Pawn.class.getSimpleName(), 'a', 0, 2, 6,}
                };
            }
        ...
        public static class ShouldReturnFalse {
            ...
            public static Object[][] data() {
                return new Object[][]{
                        ...
                        {"BLACK", "Knight", "e1", ChessColor.BLACK, Knight.class, 'e', 1, 4, 7},
                        {"WHITE", "King", "b7", ChessColor.WHITE, King.class, 'b', 7, 1, 1},
                        {"WHITE", "Bishop", "c3", ChessColor.WHITE, Bishop.class, 'c', 3, 2, 5},
                        {"WHITE", "Pawn", "g1", ChessColor.WHITE, Pawn.class, 'g', 1, 6, 7},
                        {"BLACK", "Queen", "c5", ChessColor.BLACK, Queen.class, 'c', 5, 2, 3},
                        {"BLACK", "Rook", "g8", ChessColor.BLACK, Rook.class, 'g', 8, 6, 0},
                        {"WHITE", "Pawn", "e2", ChessColor.WHITE, Pawn.class, 'e', 2, 4, 6},
                        {"BLACK", "King", "f3", ChessColor.BLACK, King.class, 'f', 3, 5, 5},
                        {"BLACK", "Queen", "d2", ChessColor.BLACK, Queen.class, 'd', 2, 3, 6},
                        {"WHITE", "Bishop", "f2", ChessColor.WHITE, Bishop.class, 'f', 2, 5, 6},
                        {"BLACK", "Pawn", "h6", ChessColor.BLACK, Pawn.class, 'h', 6, 7, 2},
                        {"WHITE", "Queen", "f8", ChessColor.WHITE, Queen.class, 'f', 8, 5, 0},
                        {"WHITE", "Rook", "b5", ChessColor.WHITE, Rook.class, 'b', 5, 1, 3},
                        {"BLACK", "Knight", "f7", ChessColor.BLACK, Knight.class, 'f', 7, 5, 1},
                        {"WHITE", "Knight", "h3", ChessColor.WHITE, Knight.class, 'h', 3, 7, 5},
                        {"BLACK", "King", "c8", ChessColor.BLACK, King.class, 'c', 8, 2, 0},
                        {"BLACK", "Knight", "b2", ChessColor.BLACK, Knight.class, 'b', 2, 1, 6},
                        {"WHITE", "Bishop", "d1", ChessColor.WHITE, Bishop.class, 'd', 1, 3, 7},
                        {"BLACK", "Bishop", "a7", ChessColor.BLACK, Bishop.class, 'a', 7, 0, 1},
                        {"WHITE", "Pawn", "f5", ChessColor.WHITE, Pawn.class, 'f', 5, 5, 3},
                        {"BLACK", "Bishop", "h8", ChessColor.BLACK, Bishop.class, 'h', 8, 7, 0},
                        {"BLACK", "Pawn", "c7", ChessColor.BLACK, Pawn.class, 'c', 7, 2, 1},
                        {"WHITE", "Rook", "h7", ChessColor.WHITE, Rook.class, 'h', 7, 7, 1},
                        {"BLACK", "Pawn", "b3", ChessColor.BLACK, Pawn.class, 'b', 3, 1, 5},
                        {"BLACK", "Queen", "g7", ChessColor.BLACK, Queen.class, 'g', 7, 6, 1},
                        {"WHITE", "Rook", "f1", ChessColor.WHITE, Rook.class, 'f', 1, 5, 7},
                        {"BLACK", "King", "e5", ChessColor.BLACK, King.class, 'e', 5, 4, 3},
                        {"WHITE", "Queen", "b6", ChessColor.WHITE, Queen.class, 'b', 6, 1, 2},
                        {"WHITE", "Bishop", "h5", ChessColor.WHITE, Bishop.class, 'h', 5, 7, 3},
                        {"WHITE", "King", "g6", ChessColor.WHITE, King.class, 'g', 6, 6, 2},
                        {"BLACK", "Knight", "g5", ChessColor.BLACK, Knight.class, 'g', 5, 6, 3},
                        {"WHITE", "Rook", "e4", ChessColor.WHITE, Rook.class, 'e', 4, 4, 4},
                        {"WHITE", "Rook", "a6", ChessColor.WHITE, Rook.class, 'a', 6, 0, 2},
                        {"BLACK", "King", "d5", ChessColor.BLACK, King.class, 'd', 5, 3, 3},
                        {"BLACK", "Knight", "c4", ChessColor.BLACK, Knight.class, 'c', 4, 2, 4},
                        {"WHITE", "Knight", "f6", ChessColor.WHITE, Knight.class, 'f', 6, 5, 2},
                        {"BLACK", "Queen", "a3", ChessColor.BLACK, Queen.class, 'a', 3, 0, 5},
                        {"BLACK", "King", "h2", ChessColor.BLACK, King.class, 'h', 2, 7, 6},
                        {"WHITE", "Pawn", "d4", ChessColor.WHITE, Pawn.class, 'd', 4, 3, 4},
                        {"BLACK", "Rook", "g3", ChessColor.BLACK, Rook.class, 'g', 3, 6, 5},
                        {"BLACK", "Bishop", "e6", ChessColor.BLACK, Bishop.class, 'e', 6, 4, 2},
                        {"BLACK", "Rook", "c1", ChessColor.BLACK, Rook.class, 'c', 1, 2, 7},
                        {"WHITE", "Queen", "h1", ChessColor.WHITE, Queen.class, 'h', 1, 7, 7},
                        {"WHITE", "Knight", "d8", ChessColor.WHITE, Knight.class, 'd', 8, 3, 0},
                        {"WHITE", "Queen", "e7", ChessColor.WHITE, Queen.class, 'e', 7, 4, 1},
                        {"BLACK", "Pawn", "a8", ChessColor.BLACK, Pawn.class, 'a', 8, 0, 0},
                        {"WHITE", "Rook", "c2", ChessColor.WHITE, Rook.class, 'c', 2, 2, 6},
                        {"WHITE", "Knight", "c6", ChessColor.WHITE, Knight.class, 'c', 6, 2, 2},
                        {"WHITE", "Knight", "e3", ChessColor.WHITE, Knight.class, 'e', 3, 4, 5},
                        {"BLACK", "Bishop", "g4", ChessColor.BLACK, Bishop.class, 'g', 4, 6, 4},
                        {"WHITE", "Knight", "a2", ChessColor.WHITE, Knight.class, 'a', 2, 0, 6},
                        {"WHITE", "Queen", "e8", ChessColor.WHITE, Queen.class, 'e', 8, 4, 0},
                        {"WHITE", "King", "a5", ChessColor.WHITE, King.class, 'a', 5, 0, 3},
                        {"WHITE", "Rook", "d6", ChessColor.WHITE, Rook.class, 'd', 6, 3, 2},
                        {"BLACK", "King", "a1", ChessColor.BLACK, King.class, 'a', 1, 0, 7},
                        {"BLACK", "King", "h4", ChessColor.BLACK, King.class, 'h', 4, 7, 4},
                        {"WHITE", "Queen", "f4", ChessColor.WHITE, Queen.class, 'f', 4, 5, 4},
                        {"WHITE", "Bishop", "d3", ChessColor.WHITE, Bishop.class, 'd', 3, 3, 5},
                        {"BLACK", "Knight", "a4", ChessColor.BLACK, Knight.class, 'a', 4, 0, 4},
                        {"BLACK", "Pawn", "d7", ChessColor.BLACK, Pawn.class, 'd', 7, 3, 1},
                        {"BLACK", "Bishop", "b8", ChessColor.BLACK, Bishop.class, 'b', 8, 1, 0},
                        {"WHITE", "Pawn", "b1", ChessColor.WHITE, Pawn.class, 'b', 1, 1, 7},
                        {"BLACK", "Knight", "g2", ChessColor.BLACK, Knight.class, 'g', 2, 6, 6},
                        {"WHITE", "Pawn", "b4", ChessColor.WHITE, Pawn.class, 'b', 4, 1, 4},
